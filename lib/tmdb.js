...
export async function getMovieDetails(id) {
  return fetchTMDB(`/movie/${id}`, 'append_to_response=credits,videos,similar,recommendations,images,external_ids');
}

export async function getTVDetails(id) {
  return fetchTMDB(`/tv/${id}`, 'append_to_response=credits,videos,similar,recommendations,seasons,images,external_ids');
}
